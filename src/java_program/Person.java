...
public class Person {      //class with the name Person
    String firstName, lastName;
    int age;   /*three fields (instance variables) with the names
firstName, lastName of type String and age of type int.*/

    public String getFirstName(){ return firstName;}//return the value of the firstName
    public String getLastName(){return lastName;}// return the value of the lastName
    public int getAge(){return age;}    //return the value of the age field.
    public void setFirstname(String firstName){  //set the value of the firstName field.
        this.firstName=firstName;}
    public void setLastname(String lastName){  //set the value of the lastname field.
        this.lastName=lastName; }
    public void setAge(int age){    //needs to set the value of the age field
        if (age>0 || age<100){this.age=age;}
        else {age=0;}                  //age field value to 0
    }
